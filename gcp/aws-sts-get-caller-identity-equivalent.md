I was looking for something like aws sts get-caller-identity for GCP (in the Python SDK). It doesn't look like they have a direct equivalent, but you can get similar details by doing the following. 
